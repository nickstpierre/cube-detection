...
void loop() {
    ...
    double sensitivity = areaUnderCurve(5,7)/areaUnderCurve(2,11); //Calculates the ratio of the magnitude around 10.3Hz/magnitude between 3-14 Hz
    
    Serial.print("Sensitivity: ");
    Serial.println(sensitivity*100);
